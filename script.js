...
/* ---------- REVEAL ---------- */
/* Fiabilité avant tout : on ne dépend plus du défilement pour révéler le
   contenu (IntersectionObserver pouvait laisser des sections invisibles sur
   certains mobiles). Chaque bloc apparaît en fondu très vite après le
   chargement de la page, dans l'ordre, sans jamais rester caché. */
const revealEls = document.querySelectorAll('.reveal');
revealEls.forEach((el, i) => {
  setTimeout(() => el.classList.add('in'), 60 + i * 25);
});
